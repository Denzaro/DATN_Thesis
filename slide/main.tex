...
\title{HỆ THỐNG DỰ BÁO VÀ ĐIỀU KHIỂN TẮC NGHẼN GIAO THÔNG TÍCH HỢP} %Title
\subtitle{Sử Dụng Học Sâu và Mô Phỏng SUMO} %Subtitle
...
\begin{frame}{Nội Dung Báo Cáo}
    \begin{itemize}
        \item \textbf{I. GIỚI THIỆU}: Lý do và Mục tiêu đề tài
        \item \textbf{II. THIẾT KẾ HỆ THỐNG}: Kiến trúc và các Mô-đun
        \item \textbf{III. KẾT QUẢ}: Triển khai và Đánh giá
