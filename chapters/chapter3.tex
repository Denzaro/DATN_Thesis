...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \textbf{[Unix\_Timestamp].xml:} Tệp tin chứa nhãn (labels) hoặc metadata tương ứng với ảnh gốc.
...
Khối tiền xử lý ảnh có vai trò chuẩn hóa và nâng cao chất lượng đầu vào trước khi đưa vào khối nhận diện và đếm phương tiện. Hệ thống thực hiện các bước tiền xử lý chính sau:
\begin{enumerate}
...
Ngược lại, nếu ảnh đầu ra đạt yêu cầu về độ sáng, ảnh sẽ được chia thành bốn vùng con có kích thước bằng nhau (tiling). 
...
Cuối cùng, các ảnh con sau khi chia không được lưu dưới dạng các tệp ảnh riêng lẻ, mà được lưu trữ dưới dạng các giá trị trong bộ nhớ. 
Cách tiếp cận này giúp giảm dung lượng lưu trữ và tối ưu thời gian xử lý của toàn bộ hệ thống.

\section{Thiết kế khối nhận diện và phân tích phương tiện}
