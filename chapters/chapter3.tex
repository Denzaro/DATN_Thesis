...
Dữ liệu trên Google Drive được tổ chức theo một cấu trúc thư mục thống nhất, phản ánh các giai đoạn xử lý trong pipeline của hệ thống. Cấu trúc này giúp đảm bảo tính nhất quán, dễ truy vết và thuận tiện cho việc tự động hóa trong các bước xử lý và mô phỏng.
...
Khối tiền xử lý ảnh có vai trò chuẩn hóa và nâng cao chất lượng đầu vào trước khi đưa vào khối nhận diện và đếm phương tiện. Hệ thống thực hiện các bước tiền xử lý chính sau:
    \begin{enumerate}
        \item \textbf{Tăng cường độ phân giải và lọc nhiễu (Super-resolution): } Sử dụng Real-ESRGAN để nâng cao độ phân giải của ảnh đầu vào, giúp làm rõ các chi tiết nhỏ và giảm nhiễu ảnh.
        \item \textbf{Chuẩn hóa kích thước ảnh (Resizing): }
    \end{enumerate}
