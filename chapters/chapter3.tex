...
\hspace*{1cm} Luồng chính khởi tạo các nhóm luồng truy xuất, nhóm luồng upload và cơ chế đồng bộ hóa rồi đi vào vòng lặp chờ nhận task từ hàng đợi \texttt{drive\_queue}. Khi có task, hệ thống phân loại: nếu là yêu cầu tạo thư mục, luồng chính kiểm tra và tạo mới trên Google Drive nếu cần; nếu là yêu cầu upload, task được phân phối cho nhóm luồng upload xử lý. Vòng lặp duy trì liên tục cho đến khi có tín hiệu ngắt, lúc này luồng chính gửi lệnh dừng, chờ các luồng con hoàn tất rồi kết thúc chương trình.
