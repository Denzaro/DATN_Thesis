...
\begin{itemize}
    ...
    \item Xây dựng mô hình dự báo mật độ giao thông: Phát triển mô hình học sâu dựa trên kiến trúc Long Short-Term Memory (LSTM) để xử lý dữ liệu chuỗi thời gian không gian (spatial-temporal). Mô hình tiếp nhận dữ liệu vận tốc, mật độ từ các cụm giao thông (clusters) để dự báo mức độ tắc nghẽn (gridlock levels) trong tương lai gần, làm cơ sở cho các quyết định điều tiết chủ động.
