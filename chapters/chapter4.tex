...
DurationAgent sử dụng LSTM và Actor-Critic training đã chứng minh hiệu quả vượt trội trong việc tối ưu hóa thông lượng mạng lưới (+88.5\%) và tăng reward tổng thể (+40.5\%). Mặc dù độ dài hàng đợi trung bình tăng lên so với baseline, đây là sự đánh đổi chiến lược để giải quyết lưu lượng giao thông lớn hơn nhiều. Mô hình hoạt động ổn định và cho thấy tiềm năng triển khai thực tế để giải quyết bài toán tắc nghẽn thông qua việc tối ưu hóa năng lực thông hành. Các cải tiến trong tương lai sẽ tập trung vào multi-TLS coordination và integration với dữ liệu thực tế.
